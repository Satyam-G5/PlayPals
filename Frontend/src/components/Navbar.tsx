    ...
    <nav className="w-full h-20 bg-white fixed top-0 flex justify-between rounded-lg shadow-lg z-10">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden flex flex-col rounded-md items-center bg-red-600 ">
          ...
          {appcontext?.booked ? (
            <Link to="/book_bsitter" className="text-xl text-white bg-red-600 p-6 hover:cursor-pointer hover:text-gray-950">
              Book a Date
            </Link>
          ) : (
            <Link to="/booked" className="text-xl text-white bg-red-600 p-6 hover:cursor-pointer hover:text-gray-950">
              Booked Date
            </Link>
          )}
      ...
      <div className="hidden md:flex md:flex-row md:justify-evenly md:mt-1 md:mr-2 ">
        ...
        {appcontext?.booked ? (
          ...
          <Link to="/booked" className="text-xl text-gray-600 p-6 hover:cursor-pointer hover:text-gray-950">
            Booked Date
          </Link>
        )}
        <Link to="/chat" className="text-xl text-gray-600 p-6 hover:cursor-pointer hover:text-gray-950">
          Chat
        </Link>
      </div>
