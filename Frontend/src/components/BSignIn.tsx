              ...
              <div
                ...
                <div className="g-0 lg:flex lg:flex-wrap">
                    ...
                    <div className="md:mx-6 md:p-12">
                      ...
                      <div className="text-center">
                        ...
                        <h4 className="mb-12 mt-1 pb-1 text-xl font-semibold">
                          Welcome Back Members , Good Gooing 
                        </h4>
                      </div>

                      <p className="mb-4">Member Login Only -</p>
                  ...
                  <div
                    ...
                    <div className="px-4 mt-44 py-6 mt- text-white md:mx-6 md:p-12">
                      <h4 className="mb-6 text-xl font-semibold text-center">
                        YOU GOT US , WE GOT YOU ::
                      </h4>
                      <p className="text-md text-center">
                      Thanks Play-Pals :-) for all you hardwork you are doing amazing and will'be counting on further support ALL THE BEST ! 
                      </p>
                    </div>
                    <div className="flex items-center justify-between pb-6 text-white mb-16">

                          <p className="mb-0 mr-2">Not a member , wish to join our crew </p>
                          <button
                            type="button"
                            className="inline-block rounded border-2 border-danger px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-danger transition duration-150 ease-in-out hover:border-danger-600 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-danger-600 focus:border-danger-600 focus:text-danger-600 focus:outline-none focus:ring-0 active:border-danger-700 active:text-danger-700 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10"
                            data-te-ripple-init
